# ====================================================================================
# Setup Project
PROJECT_NAME := provider-crosslol
...
XPKGS = provider-crosslol
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-crosslol: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Crosslol CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Crosslol controllers
...
# This target prepares repo for your provider by replacing all "crosslol"
